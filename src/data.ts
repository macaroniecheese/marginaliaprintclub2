...
export const envelopeContents = [
  {
    ...
    label: 'Art Print',
    catalog: 'MGNL-001-PL',
    note: 'An original fine art print to accompany the monthly recipe.',
  ...
  },
  {
    ...
    label: 'Recipe',
    catalog: 'MGNL-001-RC',
    note: 'Written in the old-school way, margin notes and all.',
  ...
  },
  {
    ...
    label: 'Field Notes',
    catalog: 'MGNL-001-FN',
    note: 'The research that accompanied the recipe development.',
  ...
  },
  {
    ...
    catalog: 'MGNL-001-LT',
    note: 'From my kitchen to yours, a vulnerable and personal insight into what prompted this month\u2019s investigation.',
  ...
  },
  {
    ...
    label: 'Surprise',
    catalog: 'MGNL-001-SP',
    note: 'Something different every month...a playlist, a bookmark, a folded map.',
